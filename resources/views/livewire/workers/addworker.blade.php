<main class="flex-grow p-6">
            ...
            <div class="card p-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="">
                        ...
                        <input id="project-description" class="form-input" rows="8" wire:model="phone" placeholder="ادخل هاتف المنتج"></input>
    ...
    <div class="bg-success/25 text-success text-center text-xl rounded-md p-4 mt-5" role="alert" style="width: 75%;">
        <span class="font-bold text-lg"></span> تم اضافة الموظف بنجاح
    </div>
    @endif
</main>